    ...
    <div className="relative mt-[15rem] px-5">
      <div className="flex justify-center items-center w-full">
        <div className="flex flex-col gap-2 w-full md:w-[80%] ">
          <div className="h-fit md:h-[600px] w-full flex-1/5a cursor-pointer rounded-md bg-primary flex items-center justify-center overflow-hidden">
            <img
              src={mainImage}
                ...
                <CarouselItem key={image.id} className="basis-1/3 lg:basis-1/4">
                  ...
                  >
                    <img
                      src={image.url}
                      alt="Property"
                      className="object-cover w-full h-[100px] md:h-[300px] hover:scale-105 transition-transform duration-300"
                    />
                  </div>
                </CarouselItem>
              ))}
          ...
          <h3 className="text-2xl md:text-4xl font-bold text-primary capitalize mt-5">
            {property.name}
          </h3>
          <div className="flex gap-5 font-semibold items-center">
            <h3>3 guests</h3>.<h3>1 bedroom</h3>.<h3>1 bath</h3>
          </div>
          <div className="flex gap-5 mt-3 font-semibold w-fit md:w-[80%] md:max-w-[50%] h-[100px] ring ring-gray-300 p-5 rounded-lg items-center justify-center">
            <div className="flex flex-col items-center">
              <ShieldCheck size={70} color="gold" />
            </div>
            <h3 className="hidden md:flex w-[50%]">
            ...
            <div className="flex flex-col p-5 ring ring-gray-300 w-fit  h-fit hover:shadow-lg cursor-pointer">
              <DayPicker
                ...
                classNames={{
                  ...
                  root: `${defaultClassNames.root} p-0 md:p-5 w-full md:w-fit `, // Add a shadow to the root element
              ...
              />
              <Button className="cursor-pointer text-xl mt-5">Book Visit</Button>
            </div>
          </div>
